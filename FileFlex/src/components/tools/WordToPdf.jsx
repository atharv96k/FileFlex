...
const WordToPdf = () => {
    ...
    const handleConvert = (e) => {
        e.preventDefault();
        if (!selectedFile) {
            setMessage('Please select a Word document to convert.');
            return;
        }
        // Simulate conversion
        ...
        <>
            ...
            <div className="max-w-xl mx-auto mt-12 bg-white p-8 rounded shadow">
                ...
                <p className="mb-6 text-gray-600 text-center">
                    Upload your Word document (.doc or .docx) and convert it to PDF instantly.
                </p>
                    ...
                    >
                        ...
                        {selectedFile ? (
                            ...
                            <span className="text-gray-500">
                                Drag &amp; drop your Word file here, or <span className="text-blue-600 underline">browse</span>
                            </span>
                        )}
                    </div>
                    <button
                ...
                <div className="mt-8">
                    <h2 className="text-xl font-semibold mb-2">Why Convert Word to PDF?</h2>
                    <ul className="list-disc list-inside text-gray-700 mb-4">
                        <li>PDF files preserve your document formatting across all devices and platforms.</li>
                        <li>PDFs are more secure and can be password protected.</li>
                        <li>Sharing PDFs ensures your content looks the same for everyone.</li>
                    </ul>
                    <h2 className="text-xl font-semibold mb-2">How It Works</h2>
                    <ol className="list-decimal list-inside text-gray-700 mb-4">
                        <li>Drag and drop your Word document or click to select a file.</li>
                        <li>Click "Convert to PDF" to start the conversion process.</li>
                        <li>Download your converted PDF file instantly.</li>
                    </ol>
                    <h2 className="text-xl font-semibold mb-2">Supported Formats</h2>
                    <p className="text-gray-700 mb-4">
                        This tool supports Microsoft Word files with <strong>.doc</strong> and <strong>.docx</strong> extensions.
                    </p>
